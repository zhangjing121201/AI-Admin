<template>
  ...
  >
    <t-form ref="formRef" :model="data" label-width="80px">
      ...
      <t-form-item label="博主账号" name="name">
        <t-input v-model="data.name" placeholder="输入博主账号" />
      </t-form-item>
      <t-form-item label="评论数量" name="name">
        <t-input v-model="data.name" placeholder="输入评论数量" />
      </t-form-item>
      <t-form-item label="点赞数量" name="name">
        <t-input v-model="data.name" placeholder="输入点赞数量" />
      </t-form-item>
    </t-form>
  </t-dialog>
</template>
